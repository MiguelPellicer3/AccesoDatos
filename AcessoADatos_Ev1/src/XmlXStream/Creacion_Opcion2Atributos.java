...
public class Creacion_Opcion2Atributos {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for(;;) {
				...
				document.getDocumentElement().appendChild(raiz);
				raiz.setAttribute("Id", Integer.toString(id));
				raiz.setAttribute("apellido", apellidos.trim());
				raiz.setAttribute("departamento", Integer.toString(departamento));
				raiz.setAttribute("salario", Double.toString(salario));
			...
			StreamResult result= new StreamResult(new File ("Directorio/empleados2.xml"));
